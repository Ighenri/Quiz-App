//creating an array and passing the number, questions, and answer
let questions = [
    {
        numb: 1,
        ...
        options: [
            "Hyper Text ManLanguage Preprocessor",
    ...
    {
        numb: 12,
        question: "What would be the result of 7 +'7'?",
        answer:  "77",
        options: [
            "14",
            "35",
    ...
    {
        numb: 14,
        question: "Which of these is not a css syntax",
        answer:  "aside",
        options: [
            "font-size",
            "aside",
